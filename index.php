...
<section class="main-div">
		<div class="container">
			<div class="category-part">
				<h3><a href="whole_science.php">চাকুরি বিজ্ঞপ্তি</a></h3>
			</div>
			<div class="row">
				...
				$sql="select * from news where category_name='চাকুরি বিজ্ঞপ্তি' order by news_id desc";
					...
					<div class="col-md-3">
						<div class="sub-div">
							...
							<form class="" action="singleNews.php" method="POST">
								...
								<input type="image" src="news_image/<?php echo $info['img']; ?>" alt="Read in details" width="255" height="155">
							</form>
...
<section class="main-div">
		<div class="container">
			<div class="category-part">
				<h3><a href="whole_sports.php">খেলা</a></h3>
			</div>
			<div class="row">
